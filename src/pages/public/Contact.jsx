  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] selection:bg-[#10B981] selection:text-white font-sans overflow-x-hidden text-[#0A2540]">
      ...
      <section className="relative pt-32 pb-20 md:pt-40 md:pb-32 bg-[#0A2540] overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 w-[400px] h-[400px] bg-emerald-500/20 rounded-full blur-[100px] translate-y-1/3 -translate-x-1/4" />
        
        <div className="max-w-7xl mx-auto px-6 relative z-10 text-center">
          <motion.div initial="hidden" animate="show" variants={textReveal} className="overflow-hidden">
            <h1 className="text-4xl md:text-6xl font-bold text-white tracking-tighter font-display mb-6">
              Get in <span className="text-transparent bg-clip-text bg-gradient-to-r from-teal-400 to-emerald-400">Touch</span>
            </h1>
          </motion.div>
          <motion.p 
            initial="hidden"
            animate="show"
            variants={fadeUp}
            className="text-slate-400 text-xl max-w-2xl mx-auto font-medium tracking-wide"
          >
      ...
      <section className="py-24 relative -mt-16 z-20">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            >
              <div className="w-16 h-16 bg-emerald-50 rounded-2xl flex items-center justify-center mb-6 text-[#10B981]">
                <Mail className="h-8 w-8" />
              </div>
              <h3 className="text-xl font-bold mb-2">Email Us</h3>
              <p className="text-slate-500 mb-6">Our friendly team is here to help.</p>
              <a href="mailto:inaggarwal76@gmail.com" className="text-[#10B981] font-semibold hover:underline mt-auto">inaggarwal76@gmail.com</a>
            </motion.div>
            ...
            <motion.div 
              ...
              className="bg-white p-8 md:p-10 rounded-[32px] shadow-[0_8px_30px_rgb(0,0,0,0.04)] border-2 border-[#10B981]/20 hover:border-[#10B981]/40 hover:shadow-[0_20px_50px_rgb(37,99,235,0.1)] transition-all text-center flex flex-col items-center relative overflow-hidden"
            >
              ...
              <div className="flex gap-4 mt-auto w-full justify-center">
                <button onClick={() => setIsLoginModalOpen(true)} className="text-[#10B981] font-bold hover:underline cursor-pointer">Login</button>
            ...
            >
              ...
              <a href="tel:+919888877722" className="text-[#0A2540] font-medium hover:text-[#10B981] mt-auto">+91-9888877722</a>
            </motion.div>
          </div>
        </div>
      </section>
