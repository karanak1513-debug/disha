      ...
      <div className="max-w-[1200px] mx-auto">
        <div className="flex flex-col md:flex-row gap-8">
          ...
          <div className="w-full md:w-64 flex-shrink-0">
            <nav className="flex flex-col space-y-1 bg-white p-2 border border-[#E2E8F0] rounded-[16px] shadow-sm">
              {tabs.map((tab) => {
                const Icon = tab.icon;
          ...
          <div className="flex-1 min-w-0">
            <motion.div
              ...
              className="bg-white border border-[#E2E8F0] rounded-[16px] p-6 sm:p-8 shadow-sm"
            >
              ...
              {activeTab === "security" && (
                <div className="space-y-8">
                  ...
                  <div className="pt-6 border-t border-slate-100 flex items-center justify-between">
                    <button className="px-6 py-2.5 bg-slate-900 hover:bg-slate-800 text-white text-sm font-bold rounded-lg shadow-sm transition-all">
                      Update Password
                    </button>
